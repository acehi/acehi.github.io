...
echo "subtitle:"
echo "description: \"wechat: Acehii\""
echo "image: /assets/img/convers/"
echo "optimized_image: /assets/img/convers/"
echo "category:"
echo "tags:"
echo "author: Acehi"
echo "paginate: false"
echo "insidecover: true"
echo "---"
echo ""
# 以下为LeetCode题库特有样式
echo "<style>"
echo ".p-style {"
echo "    margin: 3px 0 0 0 !important;"
echo "    font-size:16px !important;"
echo "    line-height:23px !important;"
echo "}"
echo ".div-style {"
echo "    font-size:16px !important;"
echo "    line-height:23px !important;"
echo "}"
echo ""
echo ".attention-style {"
echo "    font-size:16px !important;"
echo "    margin: 3px 0 0 0 !important;"
echo "    line-height:23px !important;"
echo "    color: #ff0a16 !important;"
echo "}"
echo ".a-style {"
echo "    color: darkgrey !important;"
echo "    margin: 2px 0 0 0 !important;"
echo "    font-size:15px !important;"
echo "    line-height:1px !important;"
